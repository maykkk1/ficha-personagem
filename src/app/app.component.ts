...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.formulario = new FormGroup({
      ...
      h1 : new FormControl(this.dados['h1']),
      h2 : new FormControl(this.dados['h2']),
      h3 : new FormControl(this.dados['h3']),
      h4 : new FormControl(this.dados['h4']),
      h5 : new FormControl(this.dados['h5']),
      h6 : new FormControl(this.dados['h6']),
      h7 : new FormControl(this.dados['h7']),
      h8 : new FormControl(this.dados['h8']),
      h9 : new FormControl(this.dados['h9']),
      h10 : new FormControl(this.dados['h10']),
      pericia1 : new FormControl(this.dados['pericia1']),
      pericia2 : new FormControl(this.dados['pericia2']),
      pericia3 : new FormControl(this.dados['pericia3']),
      pericia4 : new FormControl(this.dados['pericia4']),
      pericia5 : new FormControl(this.dados['pericia5']),
      pericia6 : new FormControl(this.dados['pericia6']),
      pericia7 : new FormControl(this.dados['pericia7']),
      pericia8 : new FormControl(this.dados['pericia8']),
      pericia9 : new FormControl(this.dados['pericia9']),
      pericia10 : new FormControl(this.dados['pericia10']),
      arma1 : new FormControl(this.dados['arma1']),
      arma2 : new FormControl(this.dados['arma2']),
      arma3 : new FormControl(this.dados['arma3']),
      arma4 : new FormControl(this.dados['arma4']),
      arma5 : new FormControl(this.dados['arma5']),
      arma6 : new FormControl(this.dados['arma6']),
      arma7 : new FormControl(this.dados['arma7']),
      arma8 : new FormControl(this.dados['arma8']),
      arma9 : new FormControl(this.dados['arma9']),
      arma10 : new FormControl(this.dados['arma10']),
      ...
      equip1 : new FormControl(this.dados['equip1']),
      equip2 : new FormControl(this.dados['equip2']),
      equip3 : new FormControl(this.dados['equip3']),
      equip4 : new FormControl(this.dados['equip4']),
      equip5 : new FormControl(this.dados['equip5']),
      equip6 : new FormControl(this.dados['equip6']),
      equip7 : new FormControl(this.dados['equip7']),
      equip8 : new FormControl(this.dados['equip8']),
      equip9 : new FormControl(this.dados['equip9']),
      equip10 : new FormControl(this.dados['equip10']),
